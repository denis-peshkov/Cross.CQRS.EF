...
> **Версия:** `9.2.0` (published / closed) · **ветка:** `release/9.2.0-EF-Core-SourceLink` · **база:** `origin/master` (`v9.0.0`) · **дата:** `2026-09-16`
>
...
>
> Дельта: `origin/master...HEAD` — **20** коммита · **33** файлов · **+544 / −285**. Open C/H/M/L пустые (план закрыт).
